 ...
 *   job manager runner  处理  job级别的 leader选择
 * make underlying（底层） job manager
 * properly reacted（正确的反应）.
 *
 *
 * Interface for a runner which executes a {@link JobMaster}.
 *执行 job master的一个接口
 *
 * jobmanager 的构造函数 需要传一个 Job master
 *ma
 */
...
//-------------------------------------------------------------------------------------------------------------------------------------------
	...
	//开启  startJobMaster  execution graph 由  jobmaster生成
