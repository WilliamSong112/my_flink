...
public class SlotManagerImpl implements SlotManager {
	...
	// ---------------------------------------------------------------------------------------------
	// Component 组件 lifecycle methods
	// ---------------------------------------------------------------------------------------------
	 ...
	 * allocation id, then the slot will be marked as free and will be subject 主题 受。。。支配 to new slot requests.
	 *
	 ...
	 * registered.
	 *
	 * 尝试为给定的插槽请求分配插槽。如果没有可用的插槽，则
	 通知资源管理器分配更多资源，并为请求设置超时
	 注册
	 *
