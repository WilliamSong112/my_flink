...
//		数据源
		SingleOutputStreamOperator<Tuple3<String, Long, String>> source = env.fromElements(
			...
			, new Tuple3<String, Long, String>("change", 1000000003001L, "45")
...
//						})
//						.within(Time.minutes(5));
					Pattern<Tuple3<String, Long, String>, ?> pattern = null;
					pattern = pattern.<Tuple3<String, Long, String>>begin("start").where(new RichIterativeCondition<Tuple3<String, Long, String>>() {
						@Override
						public boolean filter(Tuple3<String, Long, String> value, Context<Tuple3<String, Long, String>> ctx) throws Exception {
							return value.f0.equals("e");
						}
					});
					pattern = pattern.next("middle").where(new RichIterativeCondition<Tuple3<String, Long, String>>() {
						@Override
						public boolean filter(Tuple3<String, Long, String> value, Context<Tuple3<String, Long, String>> ctx) throws Exception {
							return value.f0.equals("f");
						}
					...
					pattern = pattern.next("end").where(new RichIterativeCondition<Tuple3<String, Long, String>>() {
						@Override
						public boolean filter(Tuple3<String, Long, String> value, Context<Tuple3<String, Long, String>> ctx) throws Exception {
							return value.f0.equals("g");
						}
					...
					pattern = pattern.within(Time.minutes(5));

					System.out.println(element1.f2 + "))))))))))))))))))))))))))))))))))))))))");
