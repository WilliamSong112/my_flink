...
public class SqlToOperationConverter {
	...
	private PlannerQueryOperation toQueryOperation(FlinkPlannerImpl planner, SqlNode validated) {
		...
		System.out.println("打印下rel nnode" + relational.project());
//		System.out.println(PlannerQueryOperation(relational.rel);
		//将relnode 优化成物理执行计划   .rel得到的是relnode
